              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                    ...
                    <span className={`text-[10px] font-bold uppercase px-2 py-0.5 rounded ${item.type === "QNA" ? "bg-amber-50 text-amber-600" : item.type === "PEMBELAJARAN" ? "bg-emerald-50 text-emerald-600" : "bg-sky-50 text-sky-600"}`}>{item.type === "QNA" ? "Tanya Jawab" : item.type === "PEMBELAJARAN" ? "Pembelajaran" : "Artikel"}</span>
