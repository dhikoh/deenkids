...
export const VISUAL_STYLE_PRESETS: VisualStylePreset[] = [
  ...
  },
  {
    ...
    name: 'Anime Islami',
    emoji: '✨',
    description: 'Audiens remaja — gaya Studio Ghibli',
    artStyle: 'Studio Ghibli hand-drawn illustration style with clean soft linework',
    rendering: 'soft painterly texture, beautiful watercolor-like backgrounds, and warm ambient light glow',
    colorMood: 'enchanting pastel palette with lush green, warm amber, and sky blue accents',
