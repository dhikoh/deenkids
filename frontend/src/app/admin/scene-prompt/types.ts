...
export interface SceneItem {
  ...
  /** If true, visual preset configurations are automatically generated by AI */
  isAutoVisual?: boolean;
  /** Real audio duration in seconds */
  duration: number;
}
...
export const VISUAL_STYLE_PRESETS: VisualStylePreset[] = [
  ...
  {
    id: 'digital-semi-realism',
    name: 'Digital Semi-Realism',
    emoji: '💻',
    description: 'Digital semi-realism, gritty detail',
    artStyle: 'digital semi-realistic painting style with high fidelity',
    rendering: 'highly detailed rendering with sharp textures, cinematic lighting, and subtle gritty noise overlay',
    colorMood: 'moody desaturated tones with sharp color contrasts, deep shadows, and intense dramatic highlights',
    colorClass: 'from-slate-200 to-amber-100',
  },
  {
    id: 'sinematik',
    name: 'Sinematik',
...
export const ART_STYLES = [
  ...
  { id: 'digital-semi-realistic', label: 'Digital Semi-Realistic' },
...
export const RENDERINGS = [
  ...
  { id: 'gritty-detailed', label: 'Gritty & Detailed' },
...
export const COLOR_MOODS = [
  ...
  { id: 'moody-desaturated', label: 'Moody Desaturated' },
...
export interface ProjectDraft {
  ...
  targetAudioDurationFormatted?: string;
